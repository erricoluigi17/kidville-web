...
beforeEach(() => {
  ...
  h.singleFor = {
    divise_ordini_righe: { id: R1, articolo_id: ART, articolo_nome: 'Polo', taglia: 'M', quantita: 1, ordine_id: 'o1', ordine: { scuola_id: 'sc-1' } },
...
describe('POST /api/admin/merch/cambio-taglia', () => {
  ...
  it('201 crea la nuova riga (prezzo 0, da_ordinare) senza reso di default', async () => {
  ...
  it('201 con reso_a_stock crea la rettifica +qty sulla taglia originale', async () => {
