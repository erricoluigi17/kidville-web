            ...
            >
                ...
                <div className="bg-kidville-cream/60 rounded-xl p-3 mb-4">
                    ...
                    <div className="flex justify-between mt-2 font-maven text-xs">
                        <span className="text-gray-500">Totale € {Number(pagamento.importo).toFixed(2)}</span>
                        <span className="text-gray-500">Già incassato € {Number(pagamento.importo_pagato).toFixed(2)}</span>
                ...
                <div className={`space-y-3 ${saldato ? 'hidden' : ''}`}>
                    <div>
                        <label className="font-maven text-xs text-gray-500 mb-1 block">Importo incassato (€)</label>
                        <input
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div>
                            <label className="font-maven text-xs text-gray-500 mb-1 block">Metodo</label>
                    ...
                    <div>
                        <label className="font-maven text-xs text-gray-500 mb-1 block">Note (facoltativo)</label>
