...
const GRUPPI_COPERTI: string[] = [
    ...
    'agenda',
    // News (2026-07-20): tutte le route del gruppo `news` validano con zod/@lib/validation.
    // Questo lock impedisce che una futura route news (o la GET digest) resti senza validazione.
    'news',
