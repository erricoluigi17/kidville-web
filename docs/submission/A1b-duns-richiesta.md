...
| **A D-U-N-S Number** | ❓ **da verificare/richiedere** | 🔴 **è l'unico pezzo mancante** |
| **Legal binding authority** — owner/founder, dirigente, o dipendente con delega | ⚠️ **da confermare tu**: sei il **legale rappresentante** della cooperativa? Se no, la richiesta la fa chi lo è, oppure serve una **referenza** che attesti la tua autorità | 🟡 **da confermare** |
...
- [ ] Verificato che **`info@kidville.it` riceva davvero** (prova da un indirizzo esterno)
- [ ] Confermato **chi è il legale rappresentante** della cooperativa
...
- [ ] Ricevuta da Apple la **conferma scritta sui 4 punti**
- [ ] Visura camerale in PDF pronta *(serve anche al DSA)*
- [ ] D-U-N-S ricevuto. Numero: `_________`
