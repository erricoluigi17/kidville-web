            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="border border-gray-200 rounded-xl p-4">
                    ...
                    <div className="flex flex-col gap-1.5 max-h-[280px] overflow-y-auto">
                        ...
                        {alunni.length === 0 && (
                            <p className="text-sm text-gray-400 font-maven text-center py-4">Nessun alunno trovato</p>
                        )}
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-4">
                    <div>
                        <label className="block font-maven text-sm font-semibold text-gray-700 mb-1.5">Categoria Nota</label>
                    ...
                    <div>
                        <label className="block font-maven text-sm font-semibold text-gray-700 mb-1.5">Testo della nota</label>
                        <textarea
                            value={testo}
                            onChange={(e) => setTesto(e.target.value)}
                            className="w-full border border-gray-200 p-3 rounded-xl font-maven text-sm h-28 resize-none focus:outline-none focus:ring-2 focus:ring-kidville-green/30 focus:border-kidville-green"
                    ...
                    {saveSuccess && (
                        <div className="flex items-center gap-2 bg-green-50 border border-green-200 text-green-700 p-3 rounded-xl font-maven text-sm">
                ...
                <div className="mt-6 border-t border-gray-100 pt-6">
                    ...
                    <div className="flex flex-col gap-2">
                        {note.slice(0, 10).map(n => {
                            const cat = CATEGORIA_LABELS[n.categoria] || { label: n.categoria, color: 'bg-gray-100 text-gray-600 border-gray-200' };
                            return (
                                <div key={n.id} className="border border-gray-100 rounded-xl p-3 flex items-start gap-3">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className="font-maven text-sm text-gray-500 truncate">{n.testo}</p>
                                    </div>
                                    <div className="flex-shrink-0 flex items-center gap-1">
                                        {n.firmata_il ? (
                                            <span className="text-xs text-green-600 font-maven flex items-center gap-1">
